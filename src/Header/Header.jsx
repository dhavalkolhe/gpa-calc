  ...
  return (
    <div className={`navbar ${show && "nav__black"}`}>
      <div className="navbar__left">
        ...
        >
          <Typography noWrap>
            <img src={logo} className="header__logo" alt="Company Logo"></img>
          </Typography>
        </a>
      </div>
      ...
      {!mobileNav ? (
        <div className="navbar__right">
          ...
          <Link to="/ClubsAndChapters/cncLogin" className="navbar__link">
      ...
      {openHam ? (
        <div className="navbar__mobile" onClick={closeMobileMenu}>
          <div className="navbar__coverMob" onClick={() => setOpenHam(true)}>
            <div className="navbar__close" onClick={closeMobileMenu}>
