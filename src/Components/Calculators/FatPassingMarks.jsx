...
const FatPassingMarks = () => {
  ...
  const onTheoryMarksFormSubmitHandler = (event) => {
    ...
    const totalMarks =
      Number(catOneMarks) + Number(catTwoMarks) + Number(internalTotalMarks);
        ...
        <div className="Calculator">
          <div className="calculator-main">
            <form onSubmit={onTheoryMarksFormSubmitHandler}>
              ...
              <br />
              <div className="form-input">
                <label className="internal-marks-label" htmlFor="internal-1">
                  DA/QUIZ-1 Marks
                </label>
                <input
                  id="internal-1"
              ...
              <br />
              <div className="form-input">
                <label className="internal-marks-label" htmlFor="internal-2">
                  DA/QUIZ-2 Marks
                </label>
                <input
                  id="internal-2"
              ...
              <br />
              <div className="form-input">
                <label className="internal-marks-label" htmlFor="internal-3">
                  DA/QUIZ-3 Marks
                </label>
                <input
                  id="internal-3"
          ...
          <div className="calculator-main">
            <form onSubmit={onLabMarksFormSubmitHandler}>
              ...
              <div className="lab-marks-inputs-container">
                <div className="form-input">
                  <label htmlFor="lab-1">Lab Assessment - 1 Marks</label>
                  <br />
                  <input
                    id="lab-1"
                    type="number"
                ...
                <br />
                <div className="form-input">
                  <label htmlFor="lab-2">Lab Assessment - 2 Marks</label>
                  <br />
                  <input
                    id="lab-2"
                    type="number"
              ...
              <div className="lab-marks-inputs-container">
                <div className="form-input">
                  <label htmlFor="lab-3">Lab Assessment - 3 Marks</label>
                  <br />
                  <input
                    id="lab-3"
                    type="number"
                ...
                <br />
                <div className="form-input">
                  <label htmlFor="lab-4">Lab Assessment - 4 Marks</label>
                  <br />
                  <input
                    id="lab-4"
                    type="number"
              ...
              <div className="lab-marks-inputs-container">
                <div className="form-input">
                  <label htmlFor="lab-5">Lab Assessment - 5 Marks</label>
                  <br />
                  <input
                    id="lab-5"
                    type="number"
                ...
                <br />
                <div className="form-input">
                  <label htmlFor="lab-6">Lab Assessment - 6 Marks</label>
                  <br />
                  <input
                    id="lab-6"
                    type="number"
